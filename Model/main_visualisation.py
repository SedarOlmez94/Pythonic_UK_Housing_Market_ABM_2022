...
# Visualisations-------------------------------------------------
chart_houses = ChartModule(
    [
        {"Label": "N Houses", "Color": "Blue"},
        {"Label": "Seeking a Home", "Color": "Red"},
...
people_charts = ChartModule(
    [
        {"Label": "N Population", "Color": "Red"},
        {"Label": "10 x Moving up", "Color": "Blue"},
        {"Label": "10 x Moving down", "Color": "Black"},
    ]
)

median_house_prices = ChartModule(
    [
        {"Label": "(Median House Prices) For sale", "Color": "Red"},
        {"Label": "Sold", "Color": "Blue"},
    ]
)

gini_index = ChartModule(
    [{"Label": "(gini) Prices", "Color": "Red"}, {"Label": "Incomes", "Color": "Blue"}]
)

mortgage_repayment = ChartModule(
    [{"Label": "Mortgage repayment / income", "Color": "Red"}]
)

median_house_price = ChartModule(
    [{"Label": "Median house price / median income", "Color": "Red"}]
)

median_time_on_market = ChartModule(
    [{"Label": "Median time on market", "Color": "Red"}]
)
...
server = ModularServer(
    ...
    "Housing Market",
    {
        "nRealtors": input_parameters.nRealtors,
        "width": GRID_SIZE_X,
        "height": GRID_SIZE_Y,
